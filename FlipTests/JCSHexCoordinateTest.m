...
- (void)testReuse {
    ...
    JCSHexCoordinate *original2 = [[JCSHexCoordinate alloc] initWithRow:-700 column:310];
    
    JCSHexCoordinate *mod1 = [JCSHexCoordinate hexCoordinateWithHexCoordinate:original1 direction:JCSHexDirectionNW];
    JCSHexCoordinate *mod2 = [JCSHexCoordinate hexCoordinateWithRow:-700 column:311];
    JCSHexCoordinate *mod3 = [JCSHexCoordinate hexCoordinateWithHexCoordinate:original2 direction:JCSHexDirectionE];
    JCSHexCoordinate *mod4 = [JCSHexCoordinate hexCoordinateWithRow:-700 column:311];
