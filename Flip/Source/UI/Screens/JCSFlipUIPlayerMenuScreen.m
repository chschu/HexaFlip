...
- (id)init {
    if (self = [super init]) {
        ...
        // create play button
        CCMenuItem *playItem = [CCMenuItemSprite itemWithNormalSprite:[CCSprite spriteWithSpriteFrameName:@"button-small-play-normal.png"] selectedSprite:[CCSprite spriteWithSpriteFrameName:@"button-small-play-pushed.png"] disabledSprite:[CCSprite spriteWithSpriteFrameName:@"button-small-play-disabled.png"] block:^(id sender) {
        ...
        CCMenuItem *aiEasyItem = [CCMenuItemSprite itemWithNormalSprite:[CCSprite spriteWithSpriteFrameName:@"button-large-ai-easy-normal.png"] selectedSprite:[CCSprite spriteWithSpriteFrameName:@"button-large-ai-easy-pushed.png"] block:^(id sender) {
            playerB = [self playerAIEasy];
            playItem.isEnabled = YES;
        }];
        aiEasyItem.position = ccp(-50,-40);
        
        CCMenuItem *aiMediumItem = [CCMenuItemSprite itemWithNormalSprite:[CCSprite spriteWithSpriteFrameName:@"button-large-ai-medium-normal.png"] selectedSprite:[CCSprite spriteWithSpriteFrameName:@"button-large-ai-medium-pushed.png"] block:^(id sender) {
            playerB = [self playerAIMedium];
            playItem.isEnabled = YES;
        }];
        aiMediumItem.position = ccp(50,40);

        CCMenuItem *aiHardItem = [CCMenuItemSprite itemWithNormalSprite:[CCSprite spriteWithSpriteFrameName:@"button-large-ai-hard-normal.png"] selectedSprite:[CCSprite spriteWithSpriteFrameName:@"button-large-ai-hard-pushed.png"] block:^(id sender) {
